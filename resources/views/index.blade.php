        ...
        <div class="swiper banner__slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner__item banner__space ">
                        <div class="banner__item-bg"
                            data-background="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-1.jpg')}}"></div>
                        <div class="container">
                                ...
                                <div class="col-12">
                                    <div class="banner__item-content">
                                        <div class="banner__item-wrapper">
                                            ...
                                            <p class="des color-white mb-45 mb-md-30">Welcome to DecorVista, crafting
                                                timeless interiors that tell your story. Discover a world where design
                                                meets emotion.</p>
                                        ...
                                        <div class="banner__item-content-link">
                                            <a href="https://www.youtube.com/watch?v=vkew-1KK3Sc"
                                                class="popup-video zooming d-flex align-items-center"
                ...
                <div class="swiper-slide">
                    <div class="banner__item banner__space ">
                        <div class="banner__item-bg"
                            data-background="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-2.jpg')}}"></div>
                        <div class="container">
                            <div class="banner__item__left-bg"></div>
                            <div class="banner__item__right-bg"></div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="banner__item-content">
                                        ...
                                        <div class="banner__item-content-link">
                                            <a href="https://www.youtube.com/watch?v=vkew-1KK3Sc"
                                                class="popup-video d-flex align-items-center"
                                                data-effect="mfp-move-from-top vertical-middle">
                                                <div class="icon">
                                                    <svg width="34" height="38" viewBox="0 0 34 38" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="swiper-slide">
                    <div class="banner__item banner__space ">
                        <div class="banner__item-bg"
                            data-background="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-3.jpg')}}"></div>
                        <div class="container">
                            <div class="banner__item__left-bg"></div>
                            <div class="banner__item__right-bg"></div>
                            <div class="row">
            ...
            <div class="banner__bottom-wrapper">
                ...
                <div class="banner__slider__arrow">
                    <button
                        class="banner__slider__arrow-prev d-flex align-items-center justify-content-center wow clip-t-b">
                        <svg width="27" height="16" viewBox="0 0 27 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 8L26 8" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M19.75 1L26 8L19.75 15" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </button>

                    <button
                        class="banner__slider__arrow-next d-flex align-items-center justify-content-center wow clip-t-b">
                        <svg width="27" height="16" viewBox="0 0 27 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M26 8L1 8" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M7.25 1L1 8L7.25 15" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </button>
                </div>
                ...
                <div class="swiper-container gallery-thumbs">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img
                                src="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-1.jpg')}}" alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-2.jpg')}}" alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{asset('Asset/decorVista/assets/imgs/banner-1/banner-3.jpg')}}" alt=""></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-us__media">
                        <img class="wow clip-a-z" src="{{asset('Asset/decorVista/assets/imgs/about-us/about.jpg')}}"
                            alt="image not found">
                ...
                <div class="col-lg-6">
                    <div class="about-us__content">
                        <div class="section__title-wrapper mb-45 mb-xs-40">
                            ...
                            <h2 class="section__title mb-25 title-animation">Interior Design with Different Approach
                            </h2>
                            <p class="mb-0">Et purus duis sollicitudin dignissim habitant. Egestas nulla quis venenatis
                                cras sed eu massa eu faucibus Urna fusce Et purus duis sollicitudin dig- nissim
                                habitant.</p>
                        </div>
            ...
            <div class="what-we-do__wrapper">
                ...
                <div class="row">
                    <div class="col-xl-4 has--border has--border-1">
                        <div class="what-we-do__item has--padding-pb">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-1.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">Home Interior Design</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
                                    ...
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                        ...
                                        <path d="M1 6H11" stroke="#767676" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M6 1L11 6L6 11" stroke="#767676" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                    ...
                    <div class="col-xl-4 has--border has--border-2">
                        <div class="what-we-do__item has--padding-pb">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-2.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">Home Exterior Design</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
                    ...
                    <div class="col-xl-4 has--border has--border-3">
                        <div class="what-we-do__item has--padding-pb">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-3.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">2D/3D Design Layout</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
                    ...
                    <div class="col-xl-4 has--border has--border-4">
                        <div class="what-we-do__item has--padding">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-4.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">Furniture's Design</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
                    ...
                    <div class="col-xl-4 has--border has--border-5">
                        <div class="what-we-do__item has--padding">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-5.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">Modern Home Interior</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
                    ...
                    <div class="col-xl-4 has--border has--border-6">
                        <div class="what-we-do__item has--padding">
                            <div class="what-we-do__item-icon">
                                <img src="{{asset('Asset/decorVista/assets/imgs/what-we-do/what-we-do-6.svg')}}"
                                    alt="image not found">
                            </div>
                            <div class="text">
                                <h6 class="what-we-do__item-title title-animation"><a href="#">Custom Design Plan</a>
                                </h6>
                                <p class="what-we-do__item-desc">Sagitis himos pulvinar morb socis laoreet posuere enim
                                    non auctor etiam pretium libero</p>
                                <a href="#" class="what-we-do__item-arrow">
    ...
    <section class="latest-project section-space__bottom">
        <div class="container">
            <div class="row mb-55 mb-xs-40 align-items-end">
                ...
                <div class="col-lg-6">
                    <p class=" des mb-0">Sed id lacus volutpat, imperdiet quam a, fermentum mi. Etiam urna sapien,
                        tempor in accumsan eu, consequat sed neque Etiam euismod volutpat lacus fringilla henr.</p>
                </div>
            </div>
            ...
            <div class="row gx-100 mb-minus-60">
                ...
                <div class="col-lg-6">
                    <div class="latest-project__item">
                        <div class="latest-project__media">
                            <img class="wow clip-a-z"
                                src="{{asset('Asset/decorVista/assets/imgs/latest-project/latest-project-1.jpg')}}"
                                alt="image not found">
                            <a class="icon" href="#">
                                <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.48633 23.4867L22.4072 5.56579" stroke="#906E50" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M14.3848 4.61475H23.3501V13.58" stroke="#906E50" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="latest-project__item">
                        <div class="latest-project__media">
                            <img class="wow clip-a-z"
                                src="{{asset('Asset/decorVista/assets/imgs/latest-project/latest-project-2.jpg')}}"
                                alt="image not found">
                            <a class="icon" href="#">
                                <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-6">
                    <div class="latest-project__item">
                        <div class="latest-project__media">
                            <img style="padding-top: 140px;" class="wow clip-a-z"
                                src="{{asset('Asset/decorVista/assets/imgs/latest-project/latest-project-3.jpg')}}"
                                alt="image not found">
                            <a class="icon" href="#">
                                <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-6">
                    <div class="latest-project__item">
                        <div class="latest-project__media">
                            <img style="padding-top: 140px;" class="wow clip-a-z"
                                src="{{asset('Asset/decorVista/assets/imgs/latest-project/latest-project-4.jpg')}}"
                                alt="image not found">
                            <a class="icon" href="#">
                                <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-12">
                    <div class="filter__media filter__container">
                        <div class="pic pic--left"
                            data-background="{{asset('Asset/decorVista/assets/imgs/filter__area/before-filter.png')}}">
                        </div>
                        <div class="pic pic--right"
                            data-background="{{asset('Asset/decorVista/assets/imgs/filter__area/after-filter.png')}}">
                        </div>
                        <div class="comparison-ctrl">
                            <img class="img-fluid" src="{{asset('Asset/decorVista/assets/imgs/filter__area/ctrl.svg')}}"
                                alt="icon not found">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row mb-minus-30">
                ...
                <div class="col-lg-4">
                    <div class="our-team__item">
                        <div class="our-team__item-media wow clip-a-z">
                            <img src="{{asset('Asset/decorVista/assets/imgs/our-team/team-2.jpg')}}"
                                alt="image not found">
                        </div>
                        <div class="our-team__item__text">
                ...
                <div class="col-lg-4">
                    <div class="our-team__item">
                        <div class="our-team__item-media wow clip-a-z">
                            <img src="{{asset('Asset/decorVista/assets/imgs/our-team/team-3.jpg')}}"
                                alt="image not found">
                        </div>
                        <div class="our-team__item__text">

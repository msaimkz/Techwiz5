        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="p-3 d-flex justify-content-end">
                    <a href="{{ route('Admin.gallery.create') }}" class="btn btn-primary">Create Gallery Image</a>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ asset('uploads/gallery/small/' . $img->image) }}" class="rounded"
                                            width="50px" alt="">
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger"
                                            onclick="deleteGalley('{{$gallery->id}}')">
                                        ...
                                        <a href="{{ route('Admin.gallery.view',$gallery->id) }}" class="btn btn-info">
...
@section('js')
function deleteGalley(id) {
    var url = '{{route("Admin.gallery.delete","ID")}}';

        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="p-3 d-flex justify-content-end">
                    <a href="{{ route('Admin.style.create') }}" class="btn btn-primary">Create Style</a>
                </div>
                        ...
                        <table class="table datatable" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('Admin.style.edit',$style->id) }}" class="btn btn-success">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger" onclick="deleteStyle('{{$style->id}}')">
...
function deleteStyle(id) {
    var url = '{{route("Admin-style-delete","ID")}}';

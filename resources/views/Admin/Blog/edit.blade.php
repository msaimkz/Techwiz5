    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" id="BlogForm" name="BlogForm" action="" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="slug" name="slug" readonly placeholder="Slug" value="{{ $blog->slug }}">
                        <span></span>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="description" name="description" placeholder="Blog discription" value="{{ $blog->description }}">
                        <span></span>

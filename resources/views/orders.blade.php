                                ...
                                <table class="table">
                                    <thead style=" background-color: #23b24c; color: #fff;background-color: green;border-bottom: 2px solid #000;" class="order-thead">
                                        <tr style="  padding-inline-start: 40px;">
                                            <th style="background: #5d4836; font-size: 23px;color: #fff;font-weight: 600;">Orders #</th>
                                            <th style="background: #5d4836; font-size: 23px;color: #fff;font-weight: 600;">Date Purchased</th>
                                            <th style="background: #5d4836; font-size: 23px;color: #fff;font-weight: 600;">Status</th>
                                            <th style="background: #5d4836; font-size: 23px;color: #fff;font-weight: 600;">Total</th>
                                            <th style="background: #5d4836; font-size: 23px;color: #fff;font-weight: 600;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody class="order-tbody">
                                        <tr>
                                            ...
                                            <td class="nav-nigth"></td>
                                            <td class="nav-nigth"><a style="color: #000;text-decoration-line: none;" href="#" class="btn btn-primary">View</a></td> --}}
                                        </tr>

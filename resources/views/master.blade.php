                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="{{url('/')}}">
                                <img src="{{asset('Asset/decorVista/assets/imgs/logo/logo-white.svg')}}"
                                    alt="logo not found">
                            </a>
                        </div>
                        ...
                        <div class="header__logo">
                            <a href="{{url('/')}}">
                                <div class="logo">
                                    ...
                                    {{-- <img src="{{asset('Asset/decorVista/assets/imgs/logo/logo.svg')}}" alt="logo
                                    not found"> --}}
                                </div>
                            </a>
                        </div>
        ...
        <section class="footer__area-common theme-bg-heading-primary overflow-hidden">
            ...
            <div class="container">
                <div class="footer__top-shape">
                    <img src="{{asset('Asset/decorVista/assets/imgs/footer-1/footer-cta-shape.png')}}" alt="image not
            found">
            </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="footer__widget footer__widget-item-1">
                                ...
                                <div class="footer__content mb-30 mb-xs-35">
                                    <p class="mb-0">Inoterior design consultancy firm that brings sensitivity to the
                                        design top restaurants, hotels <a href="blog-details-2.html">Read more!</a></p>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="footer__widget footer__widget-item-2">
                                ...
                                <div class="footer__link">
                                    <ul>
                                        <li><a href="about-us.html"> <i class="fa-solid fa-angles-right"></i>About
                                                Company</a></li>
                                        <li><a href="team.html"> <i class="fa-solid fa-angles-right"></i>Customer
                                                Insights</a></li>
                                        <li><a href="project.html"> <i class="fa-solid fa-angles-right"></i>Meet Our
                                                Team</a></li>
                                        <li><a href="blog.html"> <i class="fa-solid fa-angles-right"></i>Client
                                                Testimonial</a></li>
                                        <li><a href="project.html"> <i class="fa-solid fa-angles-right"></i>Privacy
                                                Policy</a></li>
                                        <li><a href="project.html"> <i class="fa-solid fa-angles-right"></i>Before
                                                After</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="footer__post">
                                    <div class="footer__post-item">
                                        <a href="blog-details.html" class="footer__post-item__thum">
                                            <img src="{{asset('Asset/decorVista/assets/imgs/footer-1/post-1.png')}}"
                                        ...
                                        <div class="footer__post-item__content">
                                                    ...
                                                    <a href="blog-details.html">
                                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#906E50" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path
                                            ...
                                            <a href="blog-details.html">
                                                <h6 class="footer__post-item__content-title">Things to Know When
                                                    Choosing the Perfect.</h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="footer__post-item">
                                        <a href="blog-details.html" class="footer__post-item__thum">
                                            <img src="{{asset('Asset/decorVista/assets/imgs/footer-1/post-2.png')}}"
                                                class="img-fluid" alt="image not found">
                                        </a>
                                        <div class="footer__post-item__content">
                                            <ul class="footer__post-item__content-meta">
                                            ...
                                            <a href="blog-details.html">
                                                <h6 class="footer__post-item__content-title">Colour Schemes to Introduce
                                                    Spring in Home</h6>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="footer__widget footer__widget-item-4">
                                ...
                                <div class="footer__contact">
                                    <ul>
                                        <li>
                                            <span class="icon">
                                                <img src="{{asset('Asset/decorVista/assets/imgs/icon/call.svg')}}"
                                                    alt="">
                                            </span>
                                            <span class="text">
                                        ...
                                        <li>
                                            <span class="icon">
                                                <img src="{{asset('Asset/decorVista/assets/imgs/icon/mail.svg')}}"
                                                    alt="">
                                            </span>
                                            <span class="text">
                                        ...
                                        <li class="address">
                                            <span class="icon">
                                                <img src="{{asset('Asset/decorVista/assets/imgs/icon/map.svg')}}"
                                                    alt="">
                                            </span>
                                            <span class="text">
                                                <span>Location</span>
                                                <a target="_blank" href="https://maps.app.goo.gl/1N77c8d8zieLRaot7">1058
                                                    Helton Ave, Berlin.</a>
                                            </span>
                                        </li>
                                    </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="footer__copyright text-lg-start text-center">
                                <p class="mb-0">Copyright © 2024 by <a href="{{url('/')}}">RRDevs.</a> All Rights
                                    Reserved.</p>
                            </div>
                        </div>
